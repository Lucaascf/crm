...
As recomendações P0.1, P0.2, P0.3, P0.4 e P1.1 (cancelamento da mudança inteira, dentro do item 5 abaixo) foram implementadas e validadas posteriormente. As demais recomendações continuam pendentes.
